...
exports.createRouter.post('/resources/data/v1', upload.single('file'), (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        if (!type || !name || !resourceId || !index) {
            throw (0, http_errors_1.default)(400, 'Fields "type", "name", "index", and "resourceId" are required.');
        }
...
exports.createRouter.put("/resource/index/v1", (0, express_async_handler_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { entryId, index } = req.body;
    if (!entryId || !mongoose_1.default.Types.ObjectId.isValid(entryId)) {
        throw (0, http_errors_1.default)(400, 'Valid "entryId" is required.');
    }
    if (index === undefined || typeof index !== "number" || index < 1) {
        throw (0, http_errors_1.default)(400, '"index" must be a positive number.');
    }
    const entry = yield resourceDataEntry_model_1.ResourceDataEntryModel.findById(entryId);
    if (!entry) {
        throw (0, http_errors_1.default)(404, 'ResourceDataEntry not found.');
    }
    entry.index = index;
